    ...
    >
      <div className="reveal-stagger-grid grid gap-4 sm:gap-5 md:grid-cols-2">
        {metrics.map((metric) => (
          <article
            key={metric.label}
            className="relative isolate overflow-x-hidden rounded-2xl border border-[var(--border-medium)] p-6 shadow-[inset_0_1px_0_color-mix(in_oklab,var(--foreground)_6%,transparent),0_16px_48px_rgba(0,0,0,0.35)]"
          ...
          >
            ...
            <div className="relative z-10">
              <p className="pb-0.5 font-[family-name:var(--font-syne)] text-xl font-semibold leading-snug tracking-tight text-[var(--accent)] sm:text-2xl">
                {metric.label}
              </p>
