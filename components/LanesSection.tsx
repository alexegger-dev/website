        ...
        {lanes.map((lane) => (
          ...
          >
            ...
            <div className="relative z-10 space-y-4">
              ...
              <p className="text-editorial text-[var(--foreground-muted)]">{lane.description}</p>
                ...
                {lane.repos.map((repo) => (
                  <li key={repo.name}>
                    <a
                      ...
                      className="focus-ring transition-surface inline-flex max-w-full touch-manipulation items-center gap-2 break-all rounded-lg px-2 py-1 font-mono text-sm text-[var(--accent)] underline-offset-4 hover:underline sm:break-normal"
                    >
