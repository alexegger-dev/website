...
export function EducationSection() {
  return (
    ...
    >
      <div className="reveal-stagger-grid grid gap-6 lg:grid-cols-2 lg:gap-8">
        <div className="space-y-6 rounded-2xl border border-[var(--border-medium)] bg-[var(--surface)] p-5 shadow-[inset_0_1px_0_color-mix(in_oklab,var(--foreground)_5%,transparent)] sm:p-8">
          <div>
